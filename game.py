...
class Actions:
    ...
    """
    # Directions
    _directions = {Directions.NORTHWEST:  (-1, 1),
                   ...
                   Directions.EAST:  (1, 0),
                   Directions.WEST:  (-1, 0),
                #   Directions.KNIGHT1: (-2,1),
                #   Directions.KNIGHT2: (-1,2),
                #   Directions.KNIGHT3: (1,2),
                #   Directions.KNIGHT4: (2,1),
                #   Directions.KNIGHT5: (2,-1),
                #   Directions.KNIGHT6: (1,-2),
                #   Directions.KNIGHT7: (-1,-2),
                #   Directions.KNIGHT8: (-2,-1),
                   Directions.STOP:  (0, 0)}
